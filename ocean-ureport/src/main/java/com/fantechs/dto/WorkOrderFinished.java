...
public class WorkOrderFinished implements Serializable {
    ...
    @Excel(name = "订单号", height = 20, width = 30,orderNum="2")
    ...
    @Excel(name = "产品料号描述", height = 20, width = 30,orderNum="6")
    ...
    @Excel(name = "产线", height = 20, width = 30,orderNum="7")
    ...
    @Excel(name = "订单箱数", height = 20, width = 30,orderNum="9")
    ...
    @Excel(name = "订单总数", height = 20, width = 30,orderNum="10")
    ...
    @Excel(name = "排产箱数", height = 20, width = 30,orderNum="11")
    ...
    @Excel(name = "排产总数", height = 20, width = 30,orderNum="12")
    ...
    @Excel(name = "生产箱数", height = 20, width = 30,orderNum="13")
    ...
    @Excel(name = "生产总数", height = 20, width = 30,orderNum="14")
    ...
    @Excel(name = "出货剩余箱数", height = 20, width = 30,orderNum="15")
    ...
    @Excel(name = "出货剩余总数", height = 20, width = 30,orderNum="16")
    ...
    @Excel(name = "操作人", height = 20, width = 30,orderNum="17")
    ...
    @Excel(name = "操作时间", height = 20, width = 30,orderNum="18")
