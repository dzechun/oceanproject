 ...
 * smt_currency
 * @author 53203
 * @date 2020-11-13 16:53:45
 */
@Data
@Table(name = "smt_currency")
public class SmtCurrency extends ValidGroup implements Serializable {
    /**
     * 币别ID
     */
    ...
    @NotNull(groups = update.class,message = "币别id不能为空")
    ...
    @Excel(name = "币别编码", height = 20, width = 30,orderNum="1")
    ...
    @Excel(name = "币别名称", height = 20, width = 30,orderNum="2")
