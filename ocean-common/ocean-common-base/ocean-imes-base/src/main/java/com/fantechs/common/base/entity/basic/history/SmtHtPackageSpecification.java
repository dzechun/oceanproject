...
/**
 * 包装规格历史表
 * smt_ht_package_specification
 * @author 53203
 * @date 2020-11-04 16:47:59
 */
@Data
@Table(name = "smt_ht_package_specification")
public class SmtHtPackageSpecification implements Serializable {
    /**
     * 包装规格历史ID
     */
    @ApiModelProperty(name="htPackageSpecificationId",value = "包装规格历史ID")
    @Excel(name = "包装规格历史ID", height = 20, width = 30,orderNum="")
    @Id
    ...
    @Excel(name = "包装规格编码", height = 20, width = 30,orderNum="")
    ...
    @Excel(name = "包装规格描述", height = 20, width = 30,orderNum="")
    ...
    @Excel(name = "包装规格数量", height = 20, width = 30,orderNum="")
