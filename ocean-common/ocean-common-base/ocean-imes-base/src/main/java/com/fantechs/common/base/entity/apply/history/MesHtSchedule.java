...
@Table(name = "mes_ht_schedule")
@Data
public class MesHtSchedule implements Serializable {
    /**
    * 排产单履历id
    */
    @ApiModelProperty(value = "排产单履历id",example = "排产单履历id")
    @Column(name = "ht_schedule_id")
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY,generator = "JDBC")
    @Excel(name = "排产单履历id")
    private Long htScheduleId;
