...
public class OmTransferOrder extends ValidGroup implements Serializable {
    ...
    @Excel(name = "调拨订单ID", height = 20, width = 30,orderNum="") 
    @Id
    ...
    @Excel(name = "调拨订单号", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "调出仓库ID", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "调入仓库ID", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "订单状态(1-打开 2-已下发 3-完成)", height = 20, width = 30,orderNum="") 
