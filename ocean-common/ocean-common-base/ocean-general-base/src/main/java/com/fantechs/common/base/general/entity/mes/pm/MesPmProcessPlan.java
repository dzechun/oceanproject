...
@Table(name = "mes_pm_process_plan")
@Data
public class MesPmProcessPlan implements Serializable {
    /**
    * 工序计划ID
    */
    @ApiModelProperty(value = "工序计划ID",example = "工序计划ID")
    ...
    * 工序计划编码
    */
    @ApiModelProperty(value = "工序计划编码",example = "工序计划编码")
    @Column(name = "process_plan_code")
    @Excel(name = "工序计划编码")
