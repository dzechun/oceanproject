...
@Data
public class QmsIncomingInspectionOrderDetDto extends QmsIncomingInspectionOrderDet implements Serializable {
    /**
     * 创建用户名称
     */
    @Transient
    ...
    @Excel(name = "不良类别", height = 20, width = 30,orderNum="15")
