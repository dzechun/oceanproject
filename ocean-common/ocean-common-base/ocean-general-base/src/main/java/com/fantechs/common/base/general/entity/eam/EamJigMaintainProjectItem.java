...
/**
 * 治具保养事项
 * eam_jig_maintain_project_item
 * @author admin
 * @date 2021-08-12 15:09:25
 */
@Data
@Table(name = "eam_jig_maintain_project_item")
public class EamJigMaintainProjectItem extends ValidGroup implements Serializable {
    /**
     * 治具保养事项ID
     */
