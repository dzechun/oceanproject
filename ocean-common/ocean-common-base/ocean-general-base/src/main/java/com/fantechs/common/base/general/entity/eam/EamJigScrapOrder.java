 ...
 * eam_jig_scrap_order
 * @author admin
 * @date 2021-08-19 13:42:40
 */
@Data
@Table(name = "eam_jig_scrap_order")
public class EamJigScrapOrder extends ValidGroup implements Serializable {
    /**
     * 治具报废单ID
     */
    ...
    @Excel(name = "治具报废单编码", height = 20, width = 30,orderNum="1")
