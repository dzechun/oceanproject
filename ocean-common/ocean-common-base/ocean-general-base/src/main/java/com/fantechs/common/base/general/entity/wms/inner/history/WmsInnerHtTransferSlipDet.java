...
/**
 * 调拨单明细
 * wms_inner_ht_transfer_slip_det
 * @author hyc
 * @date 2021-03-04 10:38:09
 */
@Data
@Table(name = "wms_inner_ht_transfer_slip_det")
public class WmsInnerHtTransferSlipDet extends ValidGroup implements Serializable {
    /**
     * 调拨单明细ID
     */
    @ApiModelProperty(name="htTransferSlipDetId",value = "调拨单明细ID")
    @Excel(name = "调拨单明细ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_transfer_slip_det_id")
    private Long htTransferSlipDetId;
