...
/**
 * ASN单明细条码履历表
 * wms_in_ht_asn_order_det_barcode
 * @author 81947
 * @date 2021-11-29 14:23:07
 */
@Data
@Table(name = "wms_in_ht_asn_order_det_barcode")
public class SrmInHtAsnOrderDetBarcode extends ValidGroup implements Serializable {
    /**
     * ASN单明细条码履历ID
     */
    @ApiModelProperty(name="htAsnOrderDetBarcodeId",value = "ASN单明细条码履历ID")
    @Excel(name = "ASN单明细条码履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_asn_order_det_barcode_id")
    private Long htAsnOrderDetBarcodeId;
