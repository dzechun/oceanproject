...
/**
 * 销退入库单履历表
 * om_ht_sales_return_order
 * @author mr.lei
 * @date 2021-06-21 15:03:29
 */
@Data
@Table(name = "om_ht_sales_return_order")
public class OmHtSalesReturnOrder extends ValidGroup implements Serializable {
    /**
     * 销退入库单履历ID
     */
    @ApiModelProperty(name="htSalesReturnOrderId",value = "销退入库单履历ID")
    @Excel(name = "销退入库单履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_sales_return_order_id")
    private Long htSalesReturnOrderId;
