...
/**
 * 作业单明细履历表
 * wms_inner_ht_job_order_det
 * @author bgkun
 * @date 2021-07-01 14:29:36
 */
@Data
@Table(name = "wms_inner_ht_job_order_det")
public class WmsInnerHtJobOrderDet extends ValidGroup implements Serializable {
    /**
     * 作业单明细履历ID
     */
    @ApiModelProperty(name="htJobOrderDetId",value = "作业单明细履历ID")
    @Excel(name = "作业单明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_job_order_det_id")
    private Long htJobOrderDetId;
    ...
    /**
     * 移位状态,移位作业需要(1-待作业 2-拣货中 3-上架中 4-已完成)
     */
    @ApiModelProperty(name="shiftStorageStatus",value = "移位状态,移位作业需要(1-待作业 2-拣货中 3-上架中 4-已完成)")
    @Excel(name = "移位状态,移位作业需要(1-待作业 2-拣货中 3-上架中 4-已完成)", height = 20, width = 30,orderNum="") 
