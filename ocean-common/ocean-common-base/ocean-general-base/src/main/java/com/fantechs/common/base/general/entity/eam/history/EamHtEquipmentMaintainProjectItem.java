...
/**
 * 设备保养事项履历表
 * eam_ht_equipment_maintain_project_item
 * @author bgkun
 * @date 2021-08-21 11:47:06
 */
@Data
@Table(name = "eam_ht_equipment_maintain_project_item")
public class EamHtEquipmentMaintainProjectItem extends ValidGroup implements Serializable {
    /**
     * 设备保养事项履历ID
     */
    @ApiModelProperty(name="htEquipmentMaintainProjectItemId",value = "设备保养事项履历ID")
    @Excel(name = "设备保养事项履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_equipment_maintain_project_item_id")
    private Long htEquipmentMaintainProjectItemId;
