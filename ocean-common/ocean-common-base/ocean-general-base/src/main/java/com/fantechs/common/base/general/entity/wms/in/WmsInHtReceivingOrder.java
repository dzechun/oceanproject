...
/**
 * 收货单履历表
 * wms_in_ht_receiving_order
 * @author mr.lei
 * @date 2021-12-15 16:01:14
 */
@Data
@Table(name = "wms_in_ht_receiving_order")
public class WmsInHtReceivingOrder extends ValidGroup implements Serializable {
    /**
     * 收货单履历ID
     */
    @ApiModelProperty(name="htReceivingOrderId",value = "收货单履历ID")
    @Excel(name = "收货单履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_receiving_order_id")
    private Long htReceivingOrderId;
    ...
    private List<WmsInHtReceivingOrderDetDto> wmsInReceivingOrderDets;
