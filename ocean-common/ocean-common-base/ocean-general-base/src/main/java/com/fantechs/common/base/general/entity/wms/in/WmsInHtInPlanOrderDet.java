...
/**
 * 入库计划单明细履历表
 * wms_in_ht_in_plan_order_det
 * @author 81947
 * @date 2021-12-08 10:13:51
 */
@Data
@Table(name = "wms_in_ht_in_plan_order_det")
public class WmsInHtInPlanOrderDet extends ValidGroup implements Serializable {
    /**
     * 入库计划单明细履历ID
     */
    @ApiModelProperty(name="htInPlanOrderDetId",value = "入库计划单明细履历ID")
    @Excel(name = "入库计划单明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_in_plan_order_det_id")
    private Long htInPlanOrderDetId;
