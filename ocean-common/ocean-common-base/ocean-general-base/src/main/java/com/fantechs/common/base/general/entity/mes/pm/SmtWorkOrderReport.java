...
public class SmtWorkOrderReport extends ValidGroup implements Serializable {
     ...
     * 工单报工ID
     */
    @ApiModelProperty(name="workOrderReportId",value = "工单报工ID")
    @Excel(name = "工单报工ID", height = 20, width = 30,orderNum="")
    @Id
    @Column(name = "work_order_report_id")
     ...
     * 完工数量
     */
    @ApiModelProperty(name="completedQuantity",value = "完工数量")
