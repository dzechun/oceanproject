...
/**
 * 车间管理-产品栈板明细表
 * mes_sfc_product_pallet_det
 * @author bgkun
 * @date 2021-05-08 09:35:04
 */
@Data
@Table(name = "mes_sfc_product_pallet_det")
public class MesSfcProductPalletDet extends ValidGroup implements Serializable {
    /**
     * 产品栈板明细表ID
     */
    @ApiModelProperty(name="productPalletDetId",value = "产品栈板明细表ID")
    @Excel(name = "产品栈板明细表ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "product_pallet_det_id")
    private Long productPalletDetId;
