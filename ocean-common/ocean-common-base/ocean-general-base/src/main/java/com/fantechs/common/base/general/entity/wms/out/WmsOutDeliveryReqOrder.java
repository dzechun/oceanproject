...
/**
 * 出库通知单
 * wms_out_delivery_req_order
 * @author admin
 * @date 2021-12-21 11:45:45
 */
@Data
@Table(name = "wms_out_delivery_req_order")
public class WmsOutDeliveryReqOrder extends ValidGroup implements Serializable {
    /**
     * 出库通知单ID
     */
    ...
    @Excel(name = "出库通知单号", height = 20, width = 30,orderNum="1",needMerge = true)
