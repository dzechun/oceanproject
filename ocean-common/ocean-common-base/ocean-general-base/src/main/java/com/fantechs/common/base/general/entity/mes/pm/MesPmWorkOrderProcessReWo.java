...
/**
 * 工单工序关系表
 * mes_pm_work_order_process_re_wo
 */
@Data
@Table(name = "mes_pm_work_order_process_re_wo")
public class MesPmWorkOrderProcessReWo extends ValidGroup implements Serializable {
    /**
     * 工单工序关系表ID
     */
     ...
     * 物料清单集合
     */
    private List<MesPmWorkOrderMaterialRePDto> list;
