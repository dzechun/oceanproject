...
@Data
public class SysDefaultCustomFormDto extends SysDefaultCustomForm implements Serializable {
     ...
     * 默认表单明细
     */
    @ApiModelProperty(name = "formDets",value = "默认表单明细")
    private List<SysDefaultCustomFormDetDto> formDets = new ArrayList<>();
}
