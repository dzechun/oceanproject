...
/**
 * 收货计划单
 * wms_in_plan_receiving_order
 * @author mr.lei
 * @date 2021-12-13 09:33:06
 */
@Data
@Table(name = "wms_in_plan_receiving_order")
public class WmsInPlanReceivingOrder extends ValidGroup implements Serializable {
    /**
     * 收货计划单ID
     */
    ...
    @Excel(name = "收货计划单号", height = 20, width = 30,orderNum="4")
    ...
    @Excel(name = "单据状态(1-待执行 2-执行中 3-收货完成)", height = 20, width = 30,orderNum="6",replace = {"1_待执行","2_执行中","3_收获完成"})
