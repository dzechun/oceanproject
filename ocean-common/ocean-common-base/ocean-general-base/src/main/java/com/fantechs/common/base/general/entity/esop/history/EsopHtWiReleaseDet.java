...
/**
 * 作业指导书-ESOP发布管理明细履历表
 * esop_ht_wi_release_det
 * @author 81947
 * @date 2021-07-09 10:21:26
 */
@Data
@Table(name = "esop_ht_wi_release_det")
public class EsopHtWiReleaseDet extends ValidGroup implements Serializable {
    /**
     * ESOP发布管理明细履历ID
     */
    @ApiModelProperty(name="htWiReleaseDetId",value = "ESOP发布管理明细履历ID")
    @Excel(name = "ESOP发布管理明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_wi_release_det_id")
    private Long htWiReleaseDetId;
