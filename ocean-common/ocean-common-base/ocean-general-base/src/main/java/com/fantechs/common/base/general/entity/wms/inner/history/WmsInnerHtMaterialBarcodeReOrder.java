...
/**
 * 所有单据条码关系履历表
 * wms_inner_ht_material_barcode_re_order
 * @author jbb
 * @date 2021-12-14 14:10:14
 */
@Data
@Table(name = "wms_inner_ht_material_barcode_re_order")
public class WmsInnerHtMaterialBarcodeReOrder extends ValidGroup implements Serializable {
    /**
     * 所有单据条码关系履历表ID
     */
    @ApiModelProperty(name="htMaterialBarcodeReOrderId",value = "所有单据条码关系履历表ID")
    @Excel(name = "所有单据条码关系履历表ID", height = 20, width = 30,orderNum="")
    @Id
    @Column(name = "ht_material_barcode_re_order_id")
    private Long htMaterialBarcodeReOrderId;
