package com.fantechs.common.base.general.entity.eng.history;
...
/**
 * 装箱汇总明细履历表
 * eng_ht_packing_order_summary_det
 * @author 81947
 * @date 2021-08-27 09:05:45
 */
@Data
@Table(name = "eng_ht_packing_order_summary_det")
public class EngHtPackingOrderSummaryDet extends ValidGroup implements Serializable {
    /**
     * 装箱汇总明细履历ID
     */
    @ApiModelProperty(name="htPackingOrderSummaryDetId",value = "装箱汇总明细履历ID")
    @Excel(name = "装箱汇总明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_packing_order_summary_det_id")
    private Long htPackingOrderSummaryDetId;
