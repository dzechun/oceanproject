...
/**
 * 产品关键事项确认单
 * mes_pm_producttion_key_issues_order
 * @author admin
 * @date 2021-06-11 11:19:19
 */
@Data
@Table(name = "mes_pm_producttion_key_issues_order")
public class MesPmProducttionKeyIssuesOrder extends ValidGroup implements Serializable {
    /**
     * 产品关键事项确认单ID
     */
     ...
     * 产品关键事项确认明细
     */
    @ApiModelProperty(name="mesPmProducttionKeyIssuesOrderDetList" ,value="产品关键事项确认明细")
    private List<MesPmProducttionKeyIssuesOrderDet> mesPmProducttionKeyIssuesOrderDetList = new ArrayList<>();
