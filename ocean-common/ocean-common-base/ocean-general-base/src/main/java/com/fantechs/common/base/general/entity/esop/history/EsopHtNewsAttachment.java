...
/**
 * 作业指导书-新闻附件履历表
 * esop_ht_news_attachment
 * @author admin
 * @date 2021-07-07 09:33:32
 */
@Data
@Table(name = "esop_ht_news_attachment")
public class EsopHtNewsAttachment extends ValidGroup implements Serializable {
    /**
     * 新闻附件履历ID
     */
    @ApiModelProperty(name="htNewsAttachmentId",value = "新闻附件履历ID")
    @Excel(name = "新闻附件履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_news_attachment_id")
    private Long htNewsAttachmentId;
