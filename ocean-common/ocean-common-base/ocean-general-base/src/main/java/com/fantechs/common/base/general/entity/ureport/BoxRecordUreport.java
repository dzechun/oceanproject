...
public class BoxRecordUreport extends ValidGroup implements Serializable {
    ...
    @Excel(name = "箱码", height = 20, width = 30,orderNum = "1")
    ...
    @Excel(name = "关箱状态", height = 20, width = 30,orderNum = "8",replace = {"未关闭_0","已关闭_1"})
    ...
    @Excel(name = "关箱时间", height = 20, width = 30,orderNum = "9",exportFormat ="yyyy-MM-dd HH:mm:ss")
    ...
    @Excel(name = "关箱人", height = 20, width = 30,orderNum = "10")
