...
/**
 * 产品关键事项确认明细
 * mes_pm_producttion_key_issues_order_det
 * @author admin
 * @date 2021-06-11 11:19:19
 */
@Data
@Table(name = "mes_pm_producttion_key_issues_order_det")
public class MesPmProducttionKeyIssuesOrderDet extends ValidGroup implements Serializable {
    /**
     * 产品关键事项确认单明细ID
     */
    @ApiModelProperty(name="producttionKeyIssuesOrderDetId",value = "产品关键事项确认单明细ID")
    @Excel(name = "产品关键事项确认单明细ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "producttion_key_issues_order_det_id")
    private Long producttionKeyIssuesOrderDetId;

    /**
     * 产品关键事项确认单ID
     */
    @ApiModelProperty(name="producttionKeyIssuesOrderId",value = "产品关键事项确认单ID")
    @Excel(name = "产品关键事项确认单ID", height = 20, width = 30,orderNum="") 
    @Column(name = "producttion_key_issues_order_id")
    private Long producttionKeyIssuesOrderId;
     ...
     * 关键事项描述
     */
    @ApiModelProperty(name="producttionKeyIssuesDetDesc" ,value="关键事项描述")
    @Transient
    @Excel(name = "关键事项名称", height = 20, width = 30,orderNum="2")
