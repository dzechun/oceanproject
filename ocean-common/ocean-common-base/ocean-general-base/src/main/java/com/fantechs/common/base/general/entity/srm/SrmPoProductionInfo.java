...
public class SrmPoProductionInfo extends ValidGroup implements Serializable {
    ...
    @Excel(name = "实际开始时间", height = 20, width = 30,orderNum="11",format ="yyyy-MM-dd HH:mm:ss")
    ...
    @Excel(name = "实际结束时间", height = 20, width = 30,orderNum="12",format ="yyyy-MM-dd HH:mm:ss")
    @JSONField(format ="yyyy-MM-dd HH:mm:ss")
    ...
    @Excel(name = "创建时间", height = 20, width = 30,orderNum="14",format ="yyyy-MM-dd HH:mm:ss")
    @JSONField(format ="yyyy-MM-dd HH:mm:ss")
    ...
    @Excel(name = "修改时间", height = 20, width = 30,orderNum="16",format ="yyyy-MM-dd HH:mm:ss")
    @JSONField(format ="yyyy-MM-dd HH:mm:ss")
