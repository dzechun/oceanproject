...
public class QmsHtInspectionType implements Serializable {
    /**
     * 检验类型历史ID
     */
    @ApiModelProperty(name="htInspectionTypeId",value = "检验类型历史ID")
    @Excel(name = "检验类型历史ID", height = 20, width = 30,orderNum="")
    @Id
    ...
    @Excel(name = "检验类型单号", height = 20, width = 30,orderNum="")
    ...
    @Excel(name = "检验类型名称", height = 20, width = 30,orderNum="")
    ...
    @Excel(name = "检验类型水平", height = 20, width = 30,orderNum="")
