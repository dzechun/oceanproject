...
/**
 * 产品关键事项维护
 * base_producttion_key_issues
 * @author admin
 * @date 2021-06-10 19:22:57
 */
@Data
@Table(name = "base_producttion_key_issues")
public class BaseProducttionKeyIssues extends ValidGroup implements Serializable {
    /**
     * 产品关键事项维护ID
     */
    @ApiModelProperty(name="producttionKeyIssuesId",value = "产品关键事项维护ID")
    @Id
     ...
     * 产品关键事项维护明细
     */
    @ApiModelProperty(name="baseProducttionKeyIssuesDetList" ,value="产品关键事项维护明细")
    private List<BaseProducttionKeyIssuesDet> baseProducttionKeyIssuesDetList = new ArrayList<>();
