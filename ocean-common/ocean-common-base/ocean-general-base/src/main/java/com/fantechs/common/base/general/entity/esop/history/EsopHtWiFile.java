 ...
 */
@Data
@Table(name = "esop_ht_wi_file")
public class EsopHtWiFile extends ValidGroup implements Serializable {
    /**
     * 作业指导书-文件履历ID
     */
    @ApiModelProperty(name="htWiFileId",value = "作业指导书-文件履历ID")
    @Excel(name = "作业指导书-文件履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_wi_file_id")
    private Long htWiFileId;
