...
/**
 * 设备点检单明细
 * eam_equ_point_inspection_order_det
 * @author bgkun
 * @date 2021-08-20 14:19:04
 */
@Data
@Table(name = "eam_equ_point_inspection_order_det")
public class EamEquPointInspectionOrderDet extends ValidGroup implements Serializable {
    /**
     * 设备点检单明细ID
     */
