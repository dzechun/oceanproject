 ...
 * esop_ht_wi_release
 * @author 81947
 * @date 2021-07-09 10:21:26
 */
@Data
@Table(name = "esop_ht_wi_release")
public class EsopHtWiRelease extends ValidGroup implements Serializable {
    /**
     * ESOP发布管理履历ID
     */
    @ApiModelProperty(name="htWiReleaseId",value = "ESOP发布管理履历ID")
    @Excel(name = "ESOP发布管理履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_wi_release_id")
    private Long htWiReleaseId;
    ...
    @Excel(name = "发布编码", height = 20, width = 30,orderNum="") 
     ...
     * 发布状态(1-待发布 2-已发布)
     */
    @ApiModelProperty(name="releaseStatus",value = "发布状态(1-待发布 2-已发布)")
    @Excel(name = "发布状态(1-待发布 2-已发布)", height = 20, width = 30,orderNum="") 
