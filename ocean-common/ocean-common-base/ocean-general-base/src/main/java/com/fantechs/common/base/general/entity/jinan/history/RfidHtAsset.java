 ...
 */
@Data
@Table(name = "rfid_ht_asset")
public class RfidHtAsset extends ValidGroup implements Serializable {
    /**
     * 资产履历ID
     */
    @ApiModelProperty(name="htAssetId",value = "资产履历ID")
    @Excel(name = "资产履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_asset_id")
    private Long htAssetId;
    ...
    @Excel(name = "资产名称", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "资产描述", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "资产条码", height = 20, width = 30,orderNum="") 
