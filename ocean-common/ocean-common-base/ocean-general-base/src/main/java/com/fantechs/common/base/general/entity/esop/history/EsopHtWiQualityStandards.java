...
/**
 * 作业指导书-品质标准履历表
 * esop_ht_wi_quality_standards
 * @author 81947
 * @date 2021-07-06 15:49:50
 */
@Data
@Table(name = "esop_ht_wi_quality_standards")
public class EsopHtWiQualityStandards extends ValidGroup implements Serializable {
    /**
     * 作业指导书-品质标准履历ID
     */
    @ApiModelProperty(name="htWiQualityStandardsId",value = "作业指导书-品质标准履历ID")
    @Excel(name = "作业指导书-品质标准履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_wi_quality_standards_id")
    private Long htWiQualityStandardsId;
