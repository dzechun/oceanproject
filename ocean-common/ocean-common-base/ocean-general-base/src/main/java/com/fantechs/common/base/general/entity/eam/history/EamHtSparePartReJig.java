...
/**
 * 备用件治具关系履历表
 * eam_ht_spare_part_re_jig
 * @author admin
 * @date 2021-09-17 19:51:30
 */
@Data
@Table(name = "eam_ht_spare_part_re_jig")
public class EamHtSparePartReJig extends ValidGroup implements Serializable {
    /**
     * 备用件治具关系履历表ID
     */
    @ApiModelProperty(name="htSparePartReJigId",value = "备用件治具关系履历表ID")
    @Excel(name = "备用件治具关系履历表ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_spare_part_re_jig_id")
    private Long htSparePartReJigId;

    /**
     * 备用件治具关系表ID
     */
    @ApiModelProperty(name="sparePartReJigId",value = "备用件治具关系表ID")
    @Excel(name = "备用件治具关系表ID", height = 20, width = 30,orderNum="") 
    @Column(name = "spare_part_re_jig_id")
    private Long sparePartReJigId;
