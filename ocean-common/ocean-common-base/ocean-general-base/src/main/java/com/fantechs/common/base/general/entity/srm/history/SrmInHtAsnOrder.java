...
/**
 * Advanced Shipping Note预先发货清单履历表
 * wms_in_ht_asn_order
 * @author 81947
 * @date 2021-11-29 14:23:06
 */
@Data
@Table(name = "wms_in_ht_asn_order")
public class SrmInHtAsnOrder extends ValidGroup implements Serializable {
    /**
     * ASN单履历ID
     */
    @ApiModelProperty(name="htAsnOrderId",value = "ASN单履历ID")
    @Excel(name = "ASN单履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_asn_order_id")
    private Long htAsnOrderId;
