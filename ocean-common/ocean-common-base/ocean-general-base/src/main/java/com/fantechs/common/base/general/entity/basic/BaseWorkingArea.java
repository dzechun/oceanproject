...
@Data
@Table(name = "base_working_area")
public class BaseWorkingArea extends ValidGroup implements Serializable {
    /**
     * 工作区域ID
     */
    ...
    @Excel(name = "状态", height = 20, width = 30,orderNum="3",replace = {"无效_0","有效_1"})
    private Byte status;
