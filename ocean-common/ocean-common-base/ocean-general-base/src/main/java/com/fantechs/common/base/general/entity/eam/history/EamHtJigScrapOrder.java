...
/**
 * 治具报废单履历表
 * eam_ht_jig_scrap_order
 * @author admin
 * @date 2021-08-19 13:42:41
 */
@Data
@Table(name = "eam_ht_jig_scrap_order")
public class EamHtJigScrapOrder extends ValidGroup implements Serializable {
    /**
     * 治具报废单履历ID
     */
    @ApiModelProperty(name="htJigScrapOrderId",value = "治具报废单履历ID")
    @Excel(name = "治具报废单履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_jig_scrap_order_id")
    private Long htJigScrapOrderId;
     ...
     * 治具报废单编码
     */
    @ApiModelProperty(name="jigScrapOrderCode",value = "治具报废单编码")
    @Excel(name = "治具报废单编码", height = 20, width = 30,orderNum="") 
    @Column(name = "jig_scrap_order_code")
    private String jigScrapOrderCode;
    ...
    @Excel(name = "申请部门", height = 20, width = 30,orderNum="4")
    ...
    @Excel(name = "使用人成本中心", height = 20, width = 30,orderNum="4")
    ...
    @Excel(name = "申请人姓名", height = 20, width = 30,orderNum="4")
    ...
    @Excel(name = "使用人姓名", height = 20, width = 30,orderNum="4")
