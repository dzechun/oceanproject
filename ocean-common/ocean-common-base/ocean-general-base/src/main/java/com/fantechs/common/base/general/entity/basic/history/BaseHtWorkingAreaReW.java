...
/**
 * 工作区工作人员关系履历表
 * base_ht_working_area_re_w
 * @author Law
 * @date 2021-04-25 20:21:19
 */
@Data
@Table(name = "base_ht_working_area_re_w")
public class BaseHtWorkingAreaReW extends ValidGroup implements Serializable {
    /**
     * 工作区工作人员关系履历表ID
     */
    @ApiModelProperty(name="htWorkingAreaReWId",value = "工作区工作人员关系履历表ID")
    @Excel(name = "工作区工作人员关系履历表ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_working_area_re_w_id")
    private Long htWorkingAreaReWId;
