...
@Data
@Table(name = "base_badness_phenotype")
public class BaseBadnessPhenotype extends ValidGroup implements Serializable {
    /**
     * 不良现象ID
     */
    ...
    @Excel(name = "不良现象代码", height = 20, width = 30,orderNum="1")
    ...
    @Excel(name = "不良现象描述", height = 20, width = 30,orderNum="2")
