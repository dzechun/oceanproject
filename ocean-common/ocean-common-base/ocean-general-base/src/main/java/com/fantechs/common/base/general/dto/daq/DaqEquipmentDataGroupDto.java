...
@Data
public class DaqEquipmentDataGroupDto extends DaqEquipmentDataGroup implements Serializable {
     ...
     */
    @Transient
    List<DaqEquipmentDataGroupParamDto> daqEquipmentDataGroupParamDtos;
