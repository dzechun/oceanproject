...
/**
 * 车间管理-返工单据履历表
 * mes_sfc_ht_rework_order
 * @author bgkun
 * @date 2021-06-15 11:08:54
 */
@Data
@Table(name = "mes_sfc_ht_rework_order")
public class MesSfcHtReworkOrder extends ValidGroup implements Serializable {
    /**
     * 返工单履历ID
     */
    @ApiModelProperty(name="htReworkOrderId",value = "返工单履历ID")
    @Excel(name = "返工单履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_rework_order_id")
    private Long htReworkOrderId;
