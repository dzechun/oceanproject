...
/**
 * 产品关键事项确认单履历表
 * mes_pm_ht_producttion_key_issues_order
 * @author admin
 * @date 2021-06-11 11:19:19
 */
@Data
@Table(name = "mes_pm_ht_producttion_key_issues_order")
public class MesPmHtProducttionKeyIssuesOrder extends ValidGroup implements Serializable {
    /**
     * 产品关键事项确认单履历ID
     */
    @ApiModelProperty(name="htProducttionKeyIssuesOrderId",value = "产品关键事项确认单履历ID")
    @Excel(name = "产品关键事项确认单履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_producttion_key_issues_order_id")
    private Long htProducttionKeyIssuesOrderId;
