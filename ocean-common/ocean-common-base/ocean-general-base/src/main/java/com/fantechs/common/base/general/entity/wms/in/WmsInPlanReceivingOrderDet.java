...
/**
 * 收货计划单明细
 * wms_in_plan_receiving_order_det
 * @author mr.lei
 * @date 2021-12-13 09:33:07
 */
@Data
@Table(name = "wms_in_plan_receiving_order_det")
public class WmsInPlanReceivingOrderDet extends ValidGroup implements Serializable {
    /**
     * 收货计划单明细ID
     */
