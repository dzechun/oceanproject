...
/**
 * <p>DT_MES_PROCESS_QUERY_REQ complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="DT_MES_PROCESS_QUERY_REQ">
 *   &lt;complexContent>
...
@XmlType(name = "DT_MES_PROCESS_QUERY_REQ", propOrder = {
    "matnr",
    "werks"
})
public class DTMESPROCESSQUERYREQ {
