...
/**
 * 过程检验项目编码检验项履历表
 * base_ht_process_inspection_item_item
 * @author admin
 * @date 2021-06-02 10:12:13
 */
@Data
@Table(name = "base_ht_process_inspection_item_item")
public class BaseHtProcessInspectionItemItem extends ValidGroup implements Serializable {
    /**
     * 过程检验项目检验项履历ID
     */
    @ApiModelProperty(name="htProcessInspectionItemItemId",value = "过程检验项目检验项履历ID")
    @Excel(name = "过程检验项目检验项履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_process_inspection_item_item_id")
    private Long htProcessInspectionItemItemId;
