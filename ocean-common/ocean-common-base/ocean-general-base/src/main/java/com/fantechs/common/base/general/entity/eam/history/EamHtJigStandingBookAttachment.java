...
/**
 * 治具台账附件履历表
 * eam_ht_jig_standing_book_attachment
 * @author admin
 * @date 2021-07-30 17:46:16
 */
@Data
@Table(name = "eam_ht_jig_standing_book_attachment")
public class EamHtJigStandingBookAttachment extends ValidGroup implements Serializable {
    /**
     * 治具台账附件履历ID
     */
    @ApiModelProperty(name="htJigStandingBookAttachmentId",value = "治具台账附件履历ID")
    @Excel(name = "治具台账附件履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_jig_standing_book_attachment_id")
    private Long htJigStandingBookAttachmentId;
