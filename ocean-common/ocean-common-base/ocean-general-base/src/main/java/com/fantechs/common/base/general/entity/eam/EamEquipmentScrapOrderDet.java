...
/**
 * 设备报废单明细
 * eam_equipment_scrap_order_det
 * @author admin
 * @date 2021-08-21 13:52:42
 */
@Data
@Table(name = "eam_equipment_scrap_order_det")
public class EamEquipmentScrapOrderDet extends ValidGroup implements Serializable {
    /**
     * 设备报废单明细ID
     */
