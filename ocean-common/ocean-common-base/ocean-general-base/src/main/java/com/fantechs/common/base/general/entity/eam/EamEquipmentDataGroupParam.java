...
/**
 * 设备数据组参数表
 * eam_equipment_data_group_param
 * @author 81947
 * @date 2021-08-02 09:15:39
 */
@Data
@Table(name = "eam_equipment_data_group_param")
public class EamEquipmentDataGroupParam extends ValidGroup implements Serializable {
    /**
     * 设备数据组参数ID
     */
