...
@Data
public class EamEquipmentJigDto extends EamEquipmentJig implements Serializable {
     ...
     * 设备绑定治具明细
     */
    @ApiModelProperty(name="list",value = "设备绑定治具明细")
    private List<EamEquipmentJigListDto> list = new ArrayList<>();
