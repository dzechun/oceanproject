...
/**
 * 设备数据组参数履历表
 * eam_ht_equipment_data_group_param
 * @author 81947
 * @date 2021-08-02 09:15:40
 */
@Data
@Table(name = "eam_ht_equipment_data_group_param")
public class EamHtEquipmentDataGroupParam extends ValidGroup implements Serializable {
    /**
     * 设备数据组参数履历ID
     */
