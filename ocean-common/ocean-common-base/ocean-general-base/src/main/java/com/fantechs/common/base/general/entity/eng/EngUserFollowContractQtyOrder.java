...
/**
 * 用户关注合同量单表
 * eng_user_follow_contract_qty_order
 * @author admin
 * @date 2021-11-03 19:15:46
 */
@Data
@Table(name = "eng_user_follow_contract_qty_order")
public class EngUserFollowContractQtyOrder extends ValidGroup implements Serializable {
    /**
     * 用户关注合同量单ID
     */
    @ApiModelProperty(name="userFollowContractQtyOrderId",value = "用户关注合同量单ID")
    @Excel(name = "用户关注合同量单ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "user_follow_contract_qty_order_id")
    private Long userFollowContractQtyOrderId;
