...
public class SrmDeliveryNoteDet extends ValidGroup implements Serializable {
     ...
     * 实际交货日期
     */
    @ApiModelProperty(name="practicalDeliveryDate",value = "实际交货日期")
    @Excel(name = "实际交货日期", height = 20, width = 30,orderNum="")
    @Column(name = "practical_delivery_date")
    private Date practicalDeliveryDate;
    ...
    @Excel(name = "需用时间", height = 20, width = 30,orderNum="",exportFormat ="yyyy-MM-dd HH:mm:ss")
