...
/**
 * <p>sendMpnewsMessageResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="sendMpnewsMessageResponse">
 *   &lt;complexContent>
...
@XmlType(name = "sendMpnewsMessageResponse", propOrder = {
    "_return"
})
public class SendMpnewsMessageResponse {
