...
/**
 * 设备绑定产品表头履历表
 * eam_ht_equipment_material
 * @author admin
 * @date 2021-06-28 14:09:03
 */
@Data
@Table(name = "eam_ht_equipment_material")
public class EamHtEquipmentMaterial extends ValidGroup implements Serializable {
    /**
     * 设备绑定产品表头履历表ID
     */
    @ApiModelProperty(name="htEquipmentMaterialId",value = "设备绑定产品表头履历表ID")
    @Excel(name = "设备绑定产品表头履历表ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_equipment_material_id")
    private Long htEquipmentMaterialId;
