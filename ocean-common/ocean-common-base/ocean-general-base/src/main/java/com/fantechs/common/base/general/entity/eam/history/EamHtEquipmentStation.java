...
/**
 * 设备工作站管理履历表
 * eam_ht_equipment_station
 * @author 81947
 * @date 2021-08-09 09:23:15
 */
@Data
@Table(name = "eam_ht_equipment_station")
public class EamHtEquipmentStation extends ValidGroup implements Serializable {
    /**
     * 设备工作站履历ID
     */
    @ApiModelProperty(name="htEquipmentStationId",value = "设备工作站履历ID")
    @Excel(name = "设备工作站履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_equipment_station_id")
    private Long htEquipmentStationId;
