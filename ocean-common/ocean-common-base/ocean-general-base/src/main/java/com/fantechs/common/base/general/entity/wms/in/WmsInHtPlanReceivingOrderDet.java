...
/**
 * 收货计划单明细履历表
 * wms_in_ht_plan_receiving_order_det
 * @author mr.lei
 * @date 2021-12-13 13:43:17
 */
@Data
@Table(name = "wms_in_ht_plan_receiving_order_det")
public class WmsInHtPlanReceivingOrderDet extends ValidGroup implements Serializable {
    /**
     * 收货计划单明细履历ID
     */
    @ApiModelProperty(name="htPlanReceivingOrderDetId",value = "收货计划单明细履历ID")
    @Excel(name = "收货计划单明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_plan_receiving_order_det_id")
    private Long htPlanReceivingOrderDetId;

    /**
     * 收货计划单明细ID
     */
    @ApiModelProperty(name="planReceivingOrderDetId",value = "收货计划单明细ID")
    @Excel(name = "收货计划单明细ID", height = 20, width = 30,orderNum="") 
    @Column(name = "plan_receiving_order_det_id")
    private Long planReceivingOrderDetId;
