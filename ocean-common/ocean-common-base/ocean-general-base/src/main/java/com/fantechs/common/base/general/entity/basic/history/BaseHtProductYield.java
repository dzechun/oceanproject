...
/**
 * 产品良率设置履历表
 * base_ht_product_yield
 * @author 81947
 * @date 2021-10-20 10:02:10
 */
@Data
@Table(name = "base_ht_product_yield")
public class BaseHtProductYield extends ValidGroup implements Serializable {
    /**
     * 产品良率设置履历ID
     */
    @ApiModelProperty(name="htProductYieldId",value = "产品良率设置履历ID")
    @Excel(name = "产品良率设置履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_product_yield_id")
    private Long htProductYieldId;
