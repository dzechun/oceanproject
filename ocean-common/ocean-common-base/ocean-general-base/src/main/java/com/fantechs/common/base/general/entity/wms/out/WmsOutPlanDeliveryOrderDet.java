...
/**
 * 出库计划单明细
 * wms_out_plan_delivery_order_det
 * @author admin
 * @date 2021-12-22 14:55:42
 */
@Data
@Table(name = "wms_out_plan_delivery_order_det")
public class WmsOutPlanDeliveryOrderDet extends ValidGroup implements Serializable {
    /**
     * 出库计划单明细ID
     */
