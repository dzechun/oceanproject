 ...
 * esop_wi_f_t_and_inspection_tool
 * @author 81947
 * @date 2021-07-06 14:05:20
 */
@Data
@Table(name = "esop_wi_f_t_and_inspection_tool")
public class EsopWiFTAndInspectionTool extends ValidGroup implements Serializable {
    /**
     * 工装设备及检具要求ID
     */
