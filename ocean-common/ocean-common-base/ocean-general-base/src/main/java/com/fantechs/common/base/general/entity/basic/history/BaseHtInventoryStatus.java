...
/**
 * 库存状态履历表
 * base_ht_inventory_status
 * @author admin
 * @date 2021-04-25 14:57:50
 */
@Data
@Table(name = "base_ht_inventory_status")
public class BaseHtInventoryStatus extends ValidGroup implements Serializable {
    /**
     * 单据类型履历ID
     */
    @ApiModelProperty(name="htInventoryStatusId",value = "单据类型履历ID")
    @Excel(name = "单据类型履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_inventory_status_id")
    private Long htInventoryStatusId;
    ...
    @Excel(name = "状态名称", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "是否可发(0-否 1-是)", height = 20, width = 30,orderNum="")
