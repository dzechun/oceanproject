 ...
 * eam_jig_backup
 * @author admin
 * @date 2021-08-11 09:32:18
 */
@Data
@Table(name = "eam_jig_backup")
public class EamJigBackup extends ValidGroup implements Serializable {
    /**
     * 治具备用件ID
     */
    ...
    @NotNull(groups = update.class,message = "治具备用件ID不能为空")
