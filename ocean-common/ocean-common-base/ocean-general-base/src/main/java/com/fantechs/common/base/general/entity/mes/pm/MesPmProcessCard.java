...
public class MesPmProcessCard extends ValidGroup implements Serializable {
    ...
    @Excel(name = "工序流转卡id", height = 20, width = 30)
    @Id
    ...
    @Excel(name = "工单流转卡编码", height = 20, width = 30)
    ...
    @Excel(name = "流转卡类型：1：工序过站、2:工序过站物料明细、3:完工上报、4:不良品、5:绑定关键物料、6:拆批作业、7:合批作业", height = 20, width = 30)
    ...
    @Excel(name = "绑定id", height = 20, width = 30)
