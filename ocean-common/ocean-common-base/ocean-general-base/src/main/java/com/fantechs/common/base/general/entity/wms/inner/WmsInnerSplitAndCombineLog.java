...
/**
 * 分合包箱栈板日志表
 * wms_inner_split_and_combine_log
 * @author admin
 * @date 2021-12-27 09:48:45
 */
@Data
@Table(name = "wms_inner_split_and_combine_log")
public class WmsInnerSplitAndCombineLog extends ValidGroup implements Serializable {
    /**
     * 分合包箱栈板记录表ID
     */
    @ApiModelProperty(name="splitAndCombineLogId",value = "分合包箱栈板记录表ID")
    @Id
    @Column(name = "split_and_combine_log_id")
    private Long splitAndCombineLogId;

    /**
     * 操作类型(1-分包箱 2-合包箱 3-分栈板 4-合栈板)
     */
    @ApiModelProperty(name="operatorType",value = "操作类型(1-分包箱 2-合包箱 3-分栈板 4-合栈板)")
    @Excel(name = "操作类型(1-分包箱 2-合包箱 3-分栈板 4-合栈板)", height = 20, width = 30,orderNum="") 
    @Column(name = "operator_type")
    private Byte operatorType;

    /**
     * 数据类型(1-分合前数据 2-分合后数据)
     */
    @ApiModelProperty(name="dataType",value = "数据类型(1-分合前数据 2-分合后数据)")
    @Excel(name = "数据类型(1-分合前数据 2-分合后数据)", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "是否系统条码(0-否 1-是)", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "条码类型(1-SN码 2-彩盒号 3-箱号 4-栈板号)", height = 20, width = 30,orderNum="") 
