...
/**
 * 设备点检单明细履历表
 * eam_ht_equ_point_inspection_order_det
 * @author bgkun
 * @date 2021-08-20 14:19:08
 */
@Data
@Table(name = "eam_ht_equ_point_inspection_order_det")
public class EamHtEquPointInspectionOrderDet extends ValidGroup implements Serializable {
    /**
     * 设备点检单明细履历ID
     */
    @ApiModelProperty(name="htEquPointInspectionOrderDetId",value = "设备点检单明细履历ID")
    @Excel(name = "设备点检单明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_equ_point_inspection_order_det_id")
    private Long htEquPointInspectionOrderDetId;

    /**
     * 设备点检单明细ID
     */
    @ApiModelProperty(name="equPointInspectionOrderDetId",value = "设备点检单明细ID")
    @Excel(name = "设备点检单明细ID", height = 20, width = 30,orderNum="") 
    @Column(name = "equ_point_inspection_order_det_id")
    private Long equPointInspectionOrderDetId;
