...
/**
 * 工序物料清单表
 * base_product_material_re_p
 * @author admin
 * @date 2021-04-28 10:06:07
 */
@Data
@Table(name = "base_product_material_re_p")
public class BaseProductMaterialReP extends ValidGroup implements Serializable {
    /**
     * 工序物料清单表ID
     */
