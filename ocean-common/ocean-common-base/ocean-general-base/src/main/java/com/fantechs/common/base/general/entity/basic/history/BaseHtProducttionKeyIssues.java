...
/**
 * 产品关键事项维护履历表
 * base_ht_producttion_key_issues
 * @author admin
 * @date 2021-06-10 19:22:57
 */
@Data
@Table(name = "base_ht_producttion_key_issues")
public class BaseHtProducttionKeyIssues extends ValidGroup implements Serializable {
    /**
     * 产品关键事项维护履历ID
     */
    @ApiModelProperty(name="htProducttionKeyIssuesId",value = "产品关键事项维护履历ID")
    @Excel(name = "产品关键事项维护履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_producttion_key_issues_id")
    private Long htProducttionKeyIssuesId;
