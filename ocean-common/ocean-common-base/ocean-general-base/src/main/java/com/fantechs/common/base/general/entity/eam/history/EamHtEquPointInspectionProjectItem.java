...
/**
 * 设备点检事项履历表
 * eam_ht_equ_point_inspection_project_item
 * @author bgkun
 * @date 2021-08-20 14:19:04
 */
@Data
@Table(name = "eam_ht_equ_point_inspection_project_item")
public class EamHtEquPointInspectionProjectItem extends ValidGroup implements Serializable {
    /**
     * 设备点检事项履历ID
     */
    @ApiModelProperty(name="htEquPointInspectionProjectItemId",value = "设备点检事项履历ID")
    @Excel(name = "设备点检事项履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_equ_point_inspection_project_item_id")
    private Long htEquPointInspectionProjectItemId;
