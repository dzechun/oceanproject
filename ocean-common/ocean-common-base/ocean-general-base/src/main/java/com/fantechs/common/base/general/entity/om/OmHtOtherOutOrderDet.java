 ...
 */
@Data
@Table(name = "om_ht_other_out_order_det")
public class OmHtOtherOutOrderDet extends ValidGroup implements Serializable {

    @ApiModelProperty(name="htOtherOutOrderDetId",value = "其他出库订单明细ID")
    @Id
    @Column(name = "ht_other_out_order_det_id")
    private Long htOtherOutOrderDetId;
    /**
     * 其他出库订单明细ID
     */
