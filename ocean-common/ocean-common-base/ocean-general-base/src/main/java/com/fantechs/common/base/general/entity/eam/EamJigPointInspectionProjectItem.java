...
/**
 * 治具点检事项
 * eam_jig_point_inspection_project_item
 * @author admin
 * @date 2021-08-16 09:33:30
 */
@Data
@Table(name = "eam_jig_point_inspection_project_item")
public class EamJigPointInspectionProjectItem extends ValidGroup implements Serializable {
    /**
     * 治具点检事项ID
     */
