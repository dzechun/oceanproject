...
/**
 * 出库计划单明细履历表
 * wms_out_ht_plan_delivery_order_det
 * @author admin
 * @date 2021-12-22 14:55:42
 */
@Data
@Table(name = "wms_out_ht_plan_delivery_order_det")
public class WmsOutHtPlanDeliveryOrderDet extends ValidGroup implements Serializable {
    /**
     * 出库计划单明细履历ID
     */
    @ApiModelProperty(name="htPlanDeliveryOrderDetId",value = "出库计划单明细履历ID")
    @Excel(name = "出库计划单明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    ...
    @Excel(name = "出库计划单明细ID", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "出库计划单ID", height = 20, width = 30,orderNum="") 
