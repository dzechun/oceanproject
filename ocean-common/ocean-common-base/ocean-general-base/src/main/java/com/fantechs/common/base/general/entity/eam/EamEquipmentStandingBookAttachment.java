...
/**
 * 设备台账附件
 * eam_equipment_standing_book_attachment
 * @author Dylan
 * @date 2021-08-20 14:28:58
 */
@Data
@Table(name = "eam_equipment_standing_book_attachment")
public class EamEquipmentStandingBookAttachment extends ValidGroup implements Serializable {
    /**
     * 设备台账附件ID
     */
