 ...
 * base_platform
 * @author admin
 * @date 2021-10-14 10:13:49
 */
@Data
@Table(name = "base_platform")
public class BasePlatform extends ValidGroup implements Serializable {
    /**
     * 月台信息ID
     */
    ...
    @Excel(name = "月台编码", height = 20, width = 30,orderNum="1")
    ...
    @Excel(name = "月台名称", height = 20, width = 30,orderNum="2")
