...
@Data
@Table(name = "base_ht_sample_transition_rule")
public class BaseHtSampleTransitionRule extends ValidGroup implements Serializable {
    /**
     * 抽样转移规则履历ID
     */
    @ApiModelProperty(name="htSampleTransitionRuleId",value = "抽样转移规则履历ID")
    @Excel(name = "抽样转移规则履历ID", height = 20, width = 30,orderNum="")
    @Id
    @Column(name = "ht_sample_transition_rule_id")
    private Long htSampleTransitionRuleId;
    ...
    @Excel(name = "抽样转移规则编码", height = 20, width = 30,orderNum="")
    ...
    @Excel(name = "抽样转移规则描述", height = 20, width = 30,orderNum="")
