...
/**
 * 设备保养单明细
 * eam_equipment_maintain_order_det
 * @author bgkun
 * @date 2021-08-21 11:47:06
 */
@Data
@Table(name = "eam_equipment_maintain_order_det")
public class EamEquipmentMaintainOrderDet extends ValidGroup implements Serializable {
    /**
     * 设备保养单明细ID
     */
