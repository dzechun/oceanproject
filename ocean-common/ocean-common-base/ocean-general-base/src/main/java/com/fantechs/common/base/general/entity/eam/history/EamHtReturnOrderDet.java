...
/**
 * 设备归还单明细履历表
 * eam_ht_return_order_det
 * @author admin
 * @date 2021-06-29 10:35:10
 */
@Data
@Table(name = "eam_ht_return_order_det")
public class EamHtReturnOrderDet extends ValidGroup implements Serializable {
    /**
     * 设备归还单明细履历ID
     */
    @ApiModelProperty(name="htReturnOrderDetId",value = "设备归还单明细履历ID")
    @Excel(name = "设备归还单明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_return_order_det_id")
    private Long htReturnOrderDetId;
