...
/**
 * 质检单表
 * @date 2020-12-16 11:23:16
 */
@Data
@Table(name = "qms_quality_inspection")
public class QmsQualityInspection extends ValidGroup implements Serializable {
    /**
     * 质检单ID
     */
    ...
    @Excel(name = "质检单号", height = 20, width = 30,orderNum="1")
    ...
    @Excel(name = "单据类型", height = 20, width = 30,orderNum="3")
    ...
    @Excel(name = "检验区域", height = 20, width = 30,orderNum="4")
    ...
    @Excel(name = "计划检验时间", height = 20, width = 30,orderNum="5",exportFormat ="yyyy-MM-dd HH:mm:ss")
    ...
    @Excel(name = "状态（0、无效 1、有效）", height = 20, width = 30,orderNum="6")
    private Byte status;
