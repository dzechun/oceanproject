...
/**
 * 设备数据组参数履历表
 * daq_ht_equipment_data_group_param
 * @author 81947
 * @date 2021-08-02 09:15:40
 */
@Data
@Table(name = "daq_ht_equipment_data_group_param")
public class DaqHtEquipmentDataGroupParam extends ValidGroup implements Serializable {
    /**
     * 设备数据组参数履历ID
     */
    @ApiModelProperty(name="htEquipmentDataGroupParamId",value = "设备数据组参数履历ID")
    @Excel(name = "设备数据组参数履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_equipment_data_group_param_id")
    private Long htEquipmentDataGroupParamId;
