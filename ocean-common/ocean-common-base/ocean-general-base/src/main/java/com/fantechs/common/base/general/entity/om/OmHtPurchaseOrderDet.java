...
/**
 * 采购订单明细履历表
 * om_ht_purchase_order_det
 * @author 81947
 * @date 2021-12-20 15:58:32
 */
@Data
@Table(name = "om_ht_purchase_order_det")
public class OmHtPurchaseOrderDet extends ValidGroup implements Serializable {
    /**
     * 采购订单明细履历ID
     */
    @ApiModelProperty(name="htPurchaseOrderDetId",value = "采购订单明细履历ID")
    @Excel(name = "采购订单明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_purchase_order_det_id")
    private Long htPurchaseOrderDetId;
