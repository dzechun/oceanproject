...
@Data
public class EamJigScrapOrderDto extends EamJigScrapOrder implements Serializable {
     ...
     * 治具报废单明细
     */
    @ApiModelProperty(name = "list",value = "治具报废单明细")
    private List<EamJigScrapOrderDetDto> list = new ArrayList<>();
