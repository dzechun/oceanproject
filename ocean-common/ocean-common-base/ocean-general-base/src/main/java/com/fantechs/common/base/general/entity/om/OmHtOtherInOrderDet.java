...
/**
 * 其他入库订单明细履历表
 * om_ht_other_in_order_det
 * @author mr.lei
 * @date 2021-06-21 17:40:47
 */
@Data
@Table(name = "om_ht_other_in_order_det")
public class OmHtOtherInOrderDet extends ValidGroup implements Serializable {
    /**
     * 其他入库订单明细履历表ID
     */
    @ApiModelProperty(name="htOtherInOrderDetId",value = "其他入库订单明细履历表ID")
    @Excel(name = "其他入库订单明细履历表ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_other_in_order_det_id")
    private Long htOtherInOrderDetId;
