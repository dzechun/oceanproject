...
public class BaseHtProductFamily implements Serializable {
    ...
    @Excel(name = "产品族履历ID", height = 20, width = 30,orderNum="") 
    @Id
    ...
    @Excel(name = "产品族id", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "产品族编码", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "产品族名称", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "产品族描述", height = 20, width = 30,orderNum="") 
    ...
    @Excel(name = "工厂（0、不启用 1、启用）", height = 20, width = 30,orderNum="")
    private Byte status;
