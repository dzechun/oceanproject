...
/**
 * 采购订单履历表
 * om_ht_purchase_order
 * @author 81947
 * @date 2021-12-20 15:58:32
 */
@Data
@Table(name = "om_ht_purchase_order")
public class OmHtPurchaseOrder extends ValidGroup implements Serializable {
    /**
     * 采购订单履历ID
     */
    @ApiModelProperty(name="htPurchaseOrderId",value = "采购订单履历ID")
    @Excel(name = "采购订单履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_purchase_order_id")
    private Long htPurchaseOrderId;
