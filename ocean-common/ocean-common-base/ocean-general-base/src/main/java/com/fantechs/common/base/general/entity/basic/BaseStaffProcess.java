...
public class BaseStaffProcess extends ValidGroup implements Serializable {
    ...
    @Excel(name = "员工工序关系id", height = 20, width = 30,orderNum="") 
    @Id
    ...
    @Excel(name = "工种id", height = 20, width = 30,orderNum="")
    ...
    @Excel(name = "有效开始时间", height = 20, width = 30,orderNum="",exportFormat ="yyyy-MM-dd HH:mm:ss")
    ...
    @Excel(name = "有效结束时间", height = 20, width = 30,orderNum="",exportFormat ="yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JsonFormat(pattern = "yyyy-MM-dd")
