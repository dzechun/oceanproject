...
public class OmSalesOrder extends ValidGroup implements Serializable {
    ...
    @Excel(name = "客户订单号", height = 20, width = 30)
    ...
    @Excel(name = "来源单据号", height = 20, width = 30)
    ...
    @Excel(name = "交货方式", height = 20, width = 30)
    ...
    @Excel(name = "销售部门", height = 20, width = 30)
    ...
    @Excel(name = "销售人员", height = 20, width = 30)
    ...
    @Excel(name = "数据来源", height = 20, width = 30)
    ...
    @Excel(name = "订单类型", height = 20, width = 30)
    ...
    @Excel(name = "制单日期", height = 20, width = 30)
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JSONField(format ="yyyy-MM-dd")
    ...
    @Excel(name = "审核人员", height = 20, width = 30)
    ...
    @Excel(name = "审核日期", height = 20, width = 30)
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JSONField(format ="yyyy-MM-dd")
    ...
    @Excel(name = "创建时间", height = 20, width = 30,exportFormat ="yyyy-MM-dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JSONField(format ="yyyy-MM-dd")
    ...
    @Excel(name = "修改时间", height = 20, width = 30,exportFormat ="yyyy-MM-dd")
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    @JSONField(format = "yyyy-MM-dd")
