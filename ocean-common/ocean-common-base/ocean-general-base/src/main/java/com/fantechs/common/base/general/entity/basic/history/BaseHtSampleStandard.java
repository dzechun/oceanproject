...
/**
 * 抽样标准履历表
 * base_ht_sample_standard
 * @author 53203
 * @date 2021-04-06 11:41:15
 */
@Data
@Table(name = "base_ht_sample_standard")
public class BaseHtSampleStandard extends ValidGroup implements Serializable {
    /**
     * 抽样标准履历ID
     */
    @ApiModelProperty(name="htSampleStandardId",value = "抽样标准履历ID")
    @Excel(name = "抽样标准履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_sample_standard_id")
    private Long htSampleStandardId;
