...
/**
 * 设备保养项目履历表
 * eam_ht_equipment_maintain_project
 * @author bgkun
 * @date 2021-08-21 11:47:06
 */
@Data
@Table(name = "eam_ht_equipment_maintain_project")
public class EamHtEquipmentMaintainProject extends ValidGroup implements Serializable {
    /**
     * 设备保养项目履历ID
     */
    @ApiModelProperty(name="htEquipmentMaintainProjectId",value = "设备保养项目履历ID")
    @Excel(name = "设备保养项目履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_equipment_maintain_project_id")
    private Long htEquipmentMaintainProjectId;
