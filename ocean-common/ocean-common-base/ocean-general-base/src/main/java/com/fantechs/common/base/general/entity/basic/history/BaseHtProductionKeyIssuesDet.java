...
/**
 * 产品关键事项维护明细履历表
 * base_ht_production_key_issues_det
 * @author admin
 * @date 2021-06-10 19:22:57
 */
@Data
@Table(name = "base_ht_production_key_issues_det")
public class BaseHtProductionKeyIssuesDet extends ValidGroup implements Serializable {
    /**
     * 产品关键事项明细履历ID
     */
    @ApiModelProperty(name="htProductionKeyIssuesDetId",value = "产品关键事项明细履历ID")
    @Excel(name = "产品关键事项明细履历ID", height = 20, width = 30,orderNum="") 
    @Id
    @Column(name = "ht_production_key_issues_det_id")
    private Long htProductionKeyIssuesDetId;
