...
public enum ErrorCodeEnum {
    ...
    PDA40012014(40012014, "生成包箱码/栈板码失败！产品料号materialId=%s与流程processId=%s关联的标签信息不存在"),
    PDA40012015(40012015, "生成包箱码/栈板码失败！产品料号materialId=%s与流程processId=%s对应标签不存在"),
    PDA40012016(40012016, "产品料号materialId=%s没有对应的关联标签信息"),
    PDA40012017(40012017, "生成包箱码/栈板码失败！条码集合barcodeRuleSetId=%s对应的条码规则关联集合信息不存在"),
    ...
    PDA40012020(40012020, "包箱号生成规则，请前往标签管理配置"),
    PDA40012021(40012021, "包箱号生成规则类别不存在，请前往标签类别管理配置"),
    PDA40012022(40012022, "获取包箱条码规则配置为空"),
    PDA40012023(40012023, "包箱条码规则详细配置没有设置"),
    PDA40012024(40012024, "产品料号materialId=%s不存在"),
    PDA40012025(40012025, "未满箱提交必须携带包箱数据"),
    PDA40012026(40012026, "需完成上次未完成作业"),
