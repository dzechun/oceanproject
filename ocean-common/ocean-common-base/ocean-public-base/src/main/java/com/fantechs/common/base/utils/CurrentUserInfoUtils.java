...
//     * @return
//     */
//    public static User getCurrentUserInfo() throws TokenValidationFailedException, BizErrorException {
//        String token = getToken();
//        Object o= redisUtil.get(token);
//        if(StringUtils.isEmpty(o)){
//            throw new TokenValidationFailedException(ErrorCode.USER_TOKEN_ERROR);
//        }
