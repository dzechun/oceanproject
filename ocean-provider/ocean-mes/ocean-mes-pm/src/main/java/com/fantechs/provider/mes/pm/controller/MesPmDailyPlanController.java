...
public class MesPmDailyPlanController {
    ...
    public ResponseEntity batchUpdate(@ApiParam(value = "必传：",required = true)@RequestBody @Validated List<MesPmDailyPlan> list){
        return ControllerUtil.returnCRUD(mesPmDailyPlanService.batchUpdate(list));
    }
