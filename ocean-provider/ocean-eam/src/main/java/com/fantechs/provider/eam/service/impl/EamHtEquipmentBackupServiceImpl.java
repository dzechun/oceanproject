 ...
 */
@Service
public class EamHtEquipmentBackupServiceImpl extends BaseService<EamHtEquipmentBackup> implements EamHtEquipmentBackupService {

    @Resource
    private EamHtEquipmentBackupMapper eamHtEquipmentBackupMapper;

    @Override
    public List<EamHtEquipmentBackup> findHtList(Map<String, Object> map) {
        ...
        return eamHtEquipmentBackupMapper.findHtList(map);
    }
}
