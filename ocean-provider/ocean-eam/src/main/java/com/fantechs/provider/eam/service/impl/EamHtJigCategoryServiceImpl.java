 ...
 */
@Service
public class EamHtJigCategoryServiceImpl extends BaseService<EamHtJigCategory> implements EamHtJigCategoryService {

    @Resource
    private EamHtJigCategoryMapper eamHtJigCategoryMapper;

    @Override
    public List<EamHtJigCategory> findHtList(Map<String, Object> map) {
        ...
        return eamHtJigCategoryMapper.findHtList(map);
    }
}
