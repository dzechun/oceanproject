 ...
 */
@Service
public class DaqEquipmentReEsServiceImpl extends BaseService<DaqEquipmentReEs> implements DaqEquipmentReEsService {

    @Resource
    private DaqEquipmentReEsMapper daqEquipmentReEsMapper;

    @Override
    public List<DaqEquipmentReEsDto> findList(Map<String, Object> map) {
