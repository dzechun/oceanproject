 ...
 */
@Service
public class DaqEquipmentDataGroupParamServiceImpl extends BaseService<DaqEquipmentDataGroupParam> implements DaqEquipmentDataGroupParamService {

    @Resource
    private DaqEquipmentDataGroupParamMapper daqEquipmentDataGroupParamMapper;

    @Override
    public List<DaqEquipmentDataGroupParamDto> findList(Map<String, Object> map) {
