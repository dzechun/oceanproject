...
//        Page<Object> page = PageHelper.startPage(searchWmsOutDeliveryOrderDet.getStartPage(),searchWmsOutDeliveryOrderDet.getPageSize());
//        List<WmsOutDeliveryOrderDet> list = wmsOutDeliveryOrderDetService.findList(searchWmsOutDeliveryOrderDet);
//        return ControllerUtil.returnDataSuccess(list,(int)page.getTotal());
//    }
    ...
    try {
        // 导出操作
        EasyPoiUtils.exportExcel(list, "导出信息", "WmsOutDeliveryOrderDet信息", WmsOutDeliveryOrderDetDto.class, "WmsOutDeliveryOrderDet.xls", response);
        } catch (Exception e) {
