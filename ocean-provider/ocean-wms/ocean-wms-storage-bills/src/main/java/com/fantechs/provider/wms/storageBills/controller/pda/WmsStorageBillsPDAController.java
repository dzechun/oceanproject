...
public class WmsStorageBillsPDAController {
    ...
    public ResponseEntity<List<WmsStorageBillsDTO>> list(
        ...
        List<WmsStorageBillsDTO> wmsStorageBillsList = wmsStorageBillsService.pdaSelectFilterAll(ControllerUtil.dynamicConditionByEntity(searchWmsStorageBillsListDTO));
    ...
    public ResponseEntity<WmsStorageBills> saveBilssDet(
        ...
        WmsStorageBills wmsStorageBills = wmsStorageBillsService.pdaSaveBilssDet(saveBilssDet);
