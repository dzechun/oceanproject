...
public interface WmsInHtPlanReceivingOrderDetService extends IService<WmsInHtPlanReceivingOrderDet> {
    List<WmsInHtPlanReceivingOrderDetDto> findList(Map<String, Object> map);
}
