...
public interface WmsInnerHtMaterialBarcodeService extends IService<WmsInnerHtMaterialBarcode> {
  //  List<WmsInnerHtMaterialBarcodeDto> findList(Map<String, Object> map);
}
