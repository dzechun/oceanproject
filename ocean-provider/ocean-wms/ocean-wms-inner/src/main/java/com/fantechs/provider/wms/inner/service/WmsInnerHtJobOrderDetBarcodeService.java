...
public interface WmsInnerHtJobOrderDetBarcodeService extends IService<WmsInnerHtJobOrderDetBarcode> {
//    List<WmsInnerHtJobOrderDetBarcodeDto> findList(Map<String, Object> map);
}
