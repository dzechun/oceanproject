...
import com.fantechs.common.base.general.entity.wms.inner.search.SearchWmsInventoryVerificationDet;
...
public class WmsInnerStockOrderController {
    ...
    @PostMapping("/add")
    public ResponseEntity add(@ApiParam(value = "必传：",required = true)@RequestBody @Validated WmsInventoryVerification wmsInventoryVerification) {
    ...
    @PostMapping("/update")
    public ResponseEntity update(@ApiParam(value = "对象，Id必传",required = true)@RequestBody @Validated(value=WmsInventoryVerification.update.class) WmsInventoryVerification wmsInventoryVerification) {
        return ControllerUtil.returnCRUD(wmsInventoryVerificationService.update(wmsInventoryVerification));
    }

    @ApiOperation("列表")
    @PostMapping("/findList")
    public ResponseEntity<List<WmsInventoryVerificationDto>> findList(@ApiParam(value = "查询对象")@RequestBody SearchWmsInventoryVerification searchWmsInventoryVerification) {
        ...
        List<WmsInventoryVerificationDto> list = wmsInventoryVerificationService.findList(ControllerUtil.dynamicConditionByEntity(searchWmsInventoryVerification));
    ...
    @RequestBody(required = false) SearchWmsInventoryVerification searchWmsInventoryVerification){
    List<WmsInventoryVerificationDto> list = wmsInventoryVerificationService.findList(ControllerUtil.dynamicConditionByEntity(searchWmsInventoryVerification));
    try {
        // 导出操作
        EasyPoiUtils.exportExcel(list, "导出信息", "WmsInventoryVerification信息", WmsInventoryVerificationDto.class, "WmsInventoryVerification.xls", response);
        } catch (Exception e) {
    ...
    public ResponseEntity<List<WmsInventoryVerificationDetDto>> findDetList(@ApiParam(value = "查询对象")@RequestBody SearchWmsInventoryVerificationDet searchWmsInventoryVerificationDet){
        ...
        List<WmsInventoryVerificationDetDto> list = wmsInventoryVerificationDetService.findList(ControllerUtil.dynamicConditionByEntity(searchWmsInventoryVerificationDet));
        return ControllerUtil.returnDataSuccess(list,(int)page.getTotal());
    }
