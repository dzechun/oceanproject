...
//            String maxCode = getMaxSerialNumber(list, lastBarCode);
    ...
    public static List<String> batchAnalysisCodeByWanbao(List<BaseBarcodeRuleSpec> list, String code,String params,Map<String,Object> map, Integer qty, String key) {
        long starttime = System.currentTimeMillis();
        ...
        if(hasKey){
            ...
            List<String> barcodes = batchAnalysisCode(list, code, params, map, 1, key);
            lastBarCode = barcodes.get(0);
        }
        log.info("key:"+key+"============ lastBarCode:"+ lastBarCode + "========= hasKey: " + hasKey);
        //获取最大流水号
