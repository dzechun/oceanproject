...
public class SmtElectronicTagStorageController {
    ...
    @PostMapping("/add")
    public ResponseEntity add(@ApiParam(value = "必传：storageId、equipmentId、electronicTagId、warehouseId、warehouseAreaId、materialId", required = true) @RequestBody @Validated SmtElectronicTagStorage smtElectronicTagStorage) {
