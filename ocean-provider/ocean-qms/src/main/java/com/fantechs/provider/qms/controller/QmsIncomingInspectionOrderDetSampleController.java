...
public class QmsIncomingInspectionOrderDetSampleController {
    ...
    public ResponseEntity batchAdd(@ApiParam(value = "必传：",required = true)@RequestBody @Validated List<QmsIncomingInspectionOrderDetSample> qmsIncomingInspectionOrderDetSampleList) {
