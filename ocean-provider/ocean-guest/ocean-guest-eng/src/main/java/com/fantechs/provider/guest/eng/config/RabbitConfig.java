...
public class RabbitConfig {
    ...
    public static final String TOPIC_EXCHANGE_MESSAGE="topic.exchange.message";
...
//    public static final String DEAD_KEY = "dead.key";
    ...
    @Bean
    public TopicExchange topicExchangeMessage() {
        return new TopicExchange(TOPIC_EXCHANGE_MESSAGE);
    }
