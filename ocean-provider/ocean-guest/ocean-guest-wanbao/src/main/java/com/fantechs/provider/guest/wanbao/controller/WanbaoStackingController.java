...
import com.fantechs.provider.guest.wanbao.dto.search.SearchWanbaoStacking;
...
public class WanbaoStackingController {
    ...
    public ResponseEntity importExcel(@ApiParam(value ="输入excel文件",required = true) @RequestPart(value="file") MultipartFile file){
        try {
            // 导入操作
            List<WanbaoStackingDto> baseAddressImports = EasyPoiUtils.importExcel(file, 0, 1, WanbaoStackingDto.class);
