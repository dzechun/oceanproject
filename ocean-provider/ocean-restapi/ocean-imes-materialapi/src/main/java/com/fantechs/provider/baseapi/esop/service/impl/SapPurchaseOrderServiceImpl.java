...
import com.fantechs.provider.baseapi.esop.service.SapPurchaseOrderService;
...
@WebService(serviceName = "PurchaseOrderService", // 与接口中指定的name一致
        ...
        endpointInterface = "com.fantechs.provider.baseapi.esop.service.SapPurchaseOrderService"// 接口地址
)
