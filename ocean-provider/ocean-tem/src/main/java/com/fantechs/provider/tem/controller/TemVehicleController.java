...
public class TemVehicleController {
    ...
    public ResponseEntity importExcel(@ApiParam(value = "输入excel文件", required = true)
        ...
        try {
            // 导入操作
            List<TemVehicleImport> temVehicleImportList = EasyPoiUtils.importExcel(file, 2, 1, TemVehicleImport.class);
            Map<String, Object> resultMap = temVehicleService.importExcel(temVehicleImportList);
