...
public class SmtWorkOrderController {
    ...
    @PostMapping("/add")
    public ResponseEntity add(@ApiParam(value = "必传：workOrderCode、materialId、workOrderQuantity、proLineId、routeId",required = true)@RequestBody @Validated SmtWorkOrder smtWorkOrder) {
