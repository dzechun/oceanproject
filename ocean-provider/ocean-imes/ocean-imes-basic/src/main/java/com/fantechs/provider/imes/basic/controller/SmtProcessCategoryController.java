...
public class SmtProcessCategoryController {
    ...
    public ResponseEntity importExcel(@ApiParam(value ="输入excel文件",required = true)
        ...
        try {
            // 导入操作
            List<SmtProcessCategoryDto> smtProcessCategoryDtos = EasyPoiUtils.importExcel(file, SmtProcessCategoryDto.class);
            Map<String, Object> resultMap = smtProcessCategoryService.importExcel(smtProcessCategoryDtos);
