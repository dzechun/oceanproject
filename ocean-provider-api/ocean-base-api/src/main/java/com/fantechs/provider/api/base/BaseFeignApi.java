...
public interface BaseFeignApi {
    ...
    ResponseEntity<BaseLabelCategory> findLabelCategoryDetail(@ApiParam(value = "标签分类id", required = true) @RequestParam @NotNull(message = "labelCategoryId不能为空") Long labelCategoryId);
